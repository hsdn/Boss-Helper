...
/* ==== South Arun ========================================================================================== */
        ...
        {huntingZoneId:   9, templateId: 1271, name: "[Остгарат] Иторо (Долина Вознесения, Кастаника)"},
        ...
        {huntingZoneId:  17, templateId: 1271, name: "[Попория] Форета (Ущелье Параанон, Пополион)"},
